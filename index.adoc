...
Android Studio Version 2022.3.1 Canary 5, Es wurde sich bewusst für eine Canary Version der IDE entschieden, da einige Profiling Tools in der derzeit aktuellen Stable-Version 2021.3 nicht erwartungsgemäß funktionierten.

Der Autor hat Vorerfahrung in der Android-Entwicklung, weswegen für die Strukturierung des Quellcodes extra Zeit genommen wurde. Genutzt wird die sogenannte Module-By-Layer Struktur, welche auf dem Clean-Architecture Prinzip aufbaut. 
Hintergrund ist das Testen der Performance in realeren Bedingungen und die Einbindung von Flutter-Modulen in besthehende Applikationen
...
Android Studio erstellt App Versionen für das Performance Profiling nicht automatisch, sondern es muss ein eigener Profile Build type erstellt werden footnote:[https://developer.android.com/studio/profile, abgerufen 2023-03-22]
...
Eine weitere Klasse ist die NewsRepository, die ähnlich zur Android-App entscheidet, ob die Artikel von der Flutter-API oder der nativen API bereitgestellt werden. Desweiteren wird eine Callback-Funktion mitgeliefert um die Daten später im UI anzeigen zu können.
